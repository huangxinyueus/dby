var rule = {
    ...
    searchUrl: 'http://search.kuwo.cn/r.s?client=kt&all=**&ft=album&newsearch=1&itemset=web_2013&cluster=0&pn=(fypage-1)&rn=10&rformat=json&encoding=utf8&show_copyright_off=1&vipver=MUSIC_8.0.3.0_BCS75&show_series_listen=1&version=9.1.8.1',
    searchable: 2,
    quickSearch: 0,
    filterable: 1,
    ...
    timeout: 5000,
    class_name: '鏈夊０灏忚&闊充箰&鐩稿０璇勪功&褰辫鍘熷０',
    class_url: '2&37&5&62',
    play_parse: true,
    lazy: $js.toString(() => {
