...
//http://122.228.85.203:1000/api.php/app/
let host = 'http://110.42.37.106:7788/api.php/app/';
let header = {
    'User-Agent': 'okhttp/3.12.11'
};
let siteKey = '';
let siteType = '';
let siteJx = ['http://122.228.85.203:7979/api/?key=7cb64e30a4ba635990e54b59adf172aa&url=', 'https://xcoo.vip/xiaojun/xiaojunjiexi.php?url='];
