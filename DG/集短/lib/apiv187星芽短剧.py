...
headerf = {
    ...
    "content-type": "application/json; charset=./qyg0.txt"
          }
...
key_bytes = key.encode('./qyg0.txt')
plain_bytes = plain_text.encode('./qyg0.txt')
cipher = AES.new(key_bytes, AES.MODE_ECB)
padded_data = pad(plain_bytes, AES.block_size)
ciphertext = cipher.encrypt(padded_data)
encrypted = base64.b64encode(ciphertext).decode('./qyg0.txt')
