...
./qyg10.txt Spider(Spider):
    ...
    def homeContent(self, filter):
        ...
        dy = {"./qyg10.txt": "类型", "area": "地区", "lang": "语言", "year": "年份", "letter": "字母", "by": "排序",
              "sort": "排序"}
        filters = {}
        ./qyg10.txtes = []
        ...
        for item in json_data:
            ...
            ./qyg10.txtes.append({"type_name": item["type_name"], "type_id": item["type_id"]})
            for key in dy:
    ...
    def categoryContent(self, tid, pg, filter, extend):
        body = {"area": extend.get('area', '全部'), "year": extend.get('year', '全部'), "type_id": tid, "page": pg,
                ...
                "./qyg10.txt": extend.get('./qyg10.txt', '全部')}
        result = {}
    ...
    def liveContent(self, url):
        id=self.homeContent(True)['./qyg10.txt'][-1]['type_id']
