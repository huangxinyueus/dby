...
//  http://www.dgpengcheng.com/vodshow/6-大陆-------2---.html

    url: 'http://www.dgpengcheng.com/vodshow/fyfilter-------fypage---.html',

    filter_url: '{{fl.cateId}}-{{fl.area}}',
    detailUrl: 'http://www.dgpengcheng.com/varticle/fyid.html',
...
//    搜索: '.module-search-item;.lazyload&&alt;.lazyload&&data-src;;a&&href',
  ...
  //    searchUrl: '/rss/index.xml?wd=**&page=fypage',
    ...
    图片来源: '@Referer=http://www.dgpengcheng.com@User-Agent=Mozilla/5.0 (Linux; Android 11; Pixel 5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.91 Mobile Safari/537.36',
...
VOD.vod_name = pdfh(html, 'h3&&Text');
 ...
 VOD.vod_pic = pd(html, '.stui-vodlist__thumb&&img&&src', input);
...
VOD.vod_director = pdfh(html, 'p:contains(导演)&&Text').replace('导演：','');
 ...
 let r_ktabs = pdfa(html,'.stui-pannel_hd');
