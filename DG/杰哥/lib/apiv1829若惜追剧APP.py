...
./qyg1.txt Spider(Spider):
    ...
    def homeContent(self, filter):
        ...
        dy = {"./qyg1.txt": "类型", "area": "地区", "lang": "语言", "year": "年份", "letter": "字母", "by": "排序",
              "sort": "排序"}
        filters = {}
        ./qyg1.txtes = []
        ...
        for item in json_data:
            ...
            ./qyg1.txtes.append({"type_name": item["type_name"], "type_id": item["type_id"]})
            for key in dy:
    ...
    def categoryContent(self, tid, pg, filter, extend):
        body = {"area": extend.get('area', '全部'), "year": extend.get('year', '全部'), "type_id": tid, "page": pg,
                ...
                "./qyg1.txt": extend.get('./qyg1.txt', '全部')}
        result = {}
    ...
    def liveContent(self, url):
        id=self.homeContent(True)['./qyg1.txt'][-1]['type_id']
